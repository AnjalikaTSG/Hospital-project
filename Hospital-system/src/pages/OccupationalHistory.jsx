          ...
          <div>
            <div className="bg-white rounded-xl shadow-lg border border-blue-200">
              <div className="px-8 py-6 border-b-2 border-blue-300 flex items-center gap-2">
                ...
                <h2 className="text-2xl font-bold text-gray-800">Add Occupational History</h2>
              </div>
              <form className="p-8 space-y-6" onSubmit={handleAddRecord}>
                ...
                <div className="flex justify-end space-x-4 mt-8">
                  <button type="button" className="flex items-center gap-2 px-6 py-3 bg-white border border-blue-500 text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transition-colors shadow-sm">
