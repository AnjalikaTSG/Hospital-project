...
const RegisterScreen = () => {
    ...
    const handleRegister = (e) => {
        ...
        navigate("/loginScreen"); // Navigate to login screen
    };
            ...
            <div className="bg-white p-6 md:p-10 w-full max-w-sm md:max-w-lg lg:max-w-2/3 shadow-lg ml-20">
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <div className="flex justify-center mt-5">
                        <button
                            type="submit"
                            className="w-full md:w-2/3 bg-blue-500 p-4 text-sm text-white uppercase font-medium rounded-lg cursor-pointer hover:bg-blue-600"
                        >
                            Register
                        </button>
                    </div>
                    <div className="text-center mt-5">
                        ...
                        <Link to="/loginScreen" className="text-blue-500 hover:text-blue-800 focus:text-purple-800 inline ml-1">
                            Login
                        </Link>
                    </div>
                </form>
